...
export async function SendTransactionSuccessMail(params: {
  ...
  dashboardUrl: string;
    ...
    const formatLocalDate = new Date(params.date).toLocaleString();
        ...
        <div class="content">
            ...
            <div class="receipt-box">
                ...
                <div class="receipt-row">
                    ...
                    <span class="value"> : ${formatLocalDate}</span>
                </div>
                <div class="receipt-row">
            ...
            <p style="font-size: 13px; margin-top: 25px;">
                If you did not authorize this movement, please <a href="mailto:support@bankhub.com">contact support</a> immediately.
            </p>
        </div>
        <div class="footer">
